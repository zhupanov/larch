...
**When set:**
- `/implement` and `/implement-and-merge` post PR announcements to Slack after creating a PR
- `/implement-and-merge` adds a `:merged:` emoji reaction to the Slack announcement after the PR is merged
...
- The `:merged:` emoji step in `/implement-and-merge` is skipped
...
- The `:merged:` emoji step in `/implement-and-merge` is also skipped
