...
# into larch. After the larch source removed the shazam directory, the old
# symlink is dead. Phase 2 must remove it, while Phase 1 creates the
# new .claude/skills/implement symlink.
...
check_symlink ".claude/skills/implement" "renamed skill (implement) should still be linked"
